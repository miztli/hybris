...
public class DefaultApplecorpsService implements ApplecorpsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultApplecorpsService.class);
	...
	{
		return DefaultApplecorpsService.class.getResourceAsStream("/applecorps/sap-hybris-platform.png");
	}
