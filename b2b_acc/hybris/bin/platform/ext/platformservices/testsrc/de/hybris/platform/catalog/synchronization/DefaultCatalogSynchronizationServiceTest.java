...
public class DefaultCatalogSynchronizationServiceTest extends BaseSynchronizationStatusServiceTest
{
	...
	public void shouldSynchronizePartiallyWithSyncJobAndConfigSynchronous()
	{
		...
		final Map<String, String> unchangedProps = ImmutableMap.<String, String>builder().put("code", "MyCode").put("ean", "MyEan")
				.build();
		...
		final Map<String, String> changedAgainProps = ImmutableMap.<String, String>builder().put("code", "MyCode").put("ean", "xxx")
				.build();
