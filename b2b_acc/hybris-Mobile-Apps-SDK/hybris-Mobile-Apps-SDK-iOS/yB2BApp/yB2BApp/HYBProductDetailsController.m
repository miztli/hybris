...
- (instancetype)initWithBackEndService:(HYBB2BService*)b2bService productId:(NSString *)selectedProductId {
...
- (void)loadProduct {
    ...
    [self.b2bService  getProductForCode:_code
...
- (void)addToCartPressed {
    ...
    if (amountToAdd.intValue > 0) {
        ...
        [[self b2bService] addProductToCurrentCart:_product.code
                                            amount:amountToAdd
