...
@property (nonatomic) UIButton       *paymentQuestionMarkButton;
@property (nonatomic) UIView         *paymentPONumberPanel;
@property (nonatomic) UITextField    *paymentPONumberField;

@property (nonatomic) UIView         *costCenterPanel;
@property (nonatomic) UILabel        *costCenterTitle;
@property (nonatomic) HYBDropDownButton  *costCenterButton;
