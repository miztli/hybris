...
public class DefaultPaginatedFlexibleSearchServiceIntegrationTest extends ServicelayerTransactionalBaseTest
{
	...
	public void shouldNotFailWithOverTheLimitPages()
	{
		...
		final Map<String, String> sortMap = new LinkedHashMap();
		sortMap.put(UserGroupModel.UID, SearchConstants.ASCENDING);
		final SearchPageData searchPageData = PaginatedSearchUtils.createSearchPageDataWithPaginationAndSorting(pageSize, currentPage,
				needsTotal, sortMap);
		parameter.setSearchPageData(searchPageData);
	...
	public void shouldSearchWithoutTotalFirstPage()
	{
		...
		final SearchPageData searchPageData = PaginatedSearchUtils.createSearchPageDataWithPaginationAndSorting(pageSize,
				currentPage, needsTotal, sortMap);
		parameter.setSearchPageData(searchPageData);
	...
	protected void assertPaginationResults(final int expectedPaginatedResultSize, final int expectedTotalResultSize,
			final int expectedSortSize, final int expectedPageSize, final int expectedCurrentPage, final int expectedNumberOfPages,
